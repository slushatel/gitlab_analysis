...
def main(project_id, region, zone, cluster_name, bucket_name,
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--region', help='Region to create clusters in/connect to', required=True)
    parser.add_argument(
    ...
    main(
        args.project_id, args.region, args.zone, args.cluster_name,
